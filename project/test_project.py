...
def test_crawler():
    ...
    assert os.path.exists('THE PATH YOU ALREADY SAVE/0050.tw-items.txt') == True

def test_regular():
    # Call regular function
    regular('0050.tw')
    # Check if txt file exists in directory
    assert os.path.exists('CTHE PATH YOU ALREADY SAVE/0050.tw.csv') == True

def test_drawing_and_save():
    # Call drawing_and_save function
    drawing_and_save('0050.tw')
    # Check if png file exists in directory
    assert os.path.exists('THE PATH YOU ALREADY SAVE/Stock Index of 0050.tw.png') == True
